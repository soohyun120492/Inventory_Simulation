...
# 시나리오 1
items = [SKU("A001", stock=449, safety_stock=109, order_qty=595, avg_daily_demand=85),
        SKU("A002", stock=498, safety_stock=138, order_qty=630, avg_daily_demand=90),
        SKU("A003", stock=621, safety_stock=141, order_qty=840, avg_daily_demand=120)
]

# # 시나리오 2
# items = [SKU("A001", stock=449, safety_stock=109, order_qty=680, avg_daily_demand=85),
#         SKU("A002", stock=538, safety_stock=178, order_qty=630, avg_daily_demand=90),
#         SKU("A003", stock=695, safety_stock=215, order_qty=840, avg_daily_demand=120),
# ]
